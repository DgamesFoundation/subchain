...
import (
	...
	"github.com/DgamesFoundation/subchain/fabric/core/crypto/primitives"
	"github.com/DgamesFoundation/subchain/fabric/flogging"
	"github.com/DgamesFoundation/subchain/fabric/core/util"
	pb "github.com/DgamesFoundation/subchain/fabric/membersrvc/protos"
...
// NewDefaultPeriodCertificateSpecWithCommonName creates a new certificate spec with notBefore a minute ago and not after 36500 days from notBefore and a specifc commonName.
//
func NewDefaultPeriodCertificateSpecWithCommonName(id string, commonName string, serialNumber *big.Int, pub interface{}, usage x509.KeyUsage, opt ...pkix.Extension) *CertificateSpec {
	...
	notAfter := notBefore.Add(time.Hour * 24 * 36500)
