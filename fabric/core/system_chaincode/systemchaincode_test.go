...
import (
	...
	"github.com/DgamesFoundation/subchain/fabric/core/system_chaincode/api"
	"github.com/DgamesFoundation/subchain/fabric/core/system_chaincode/samplesyscc"
...
func TestExecuteDeploySysChaincode(t *testing.T) {
	...
	systemChaincodes = []*api.SystemChaincode{
		{
			Enabled:   true,
			Name:      "sample_syscc",
			Path:      "github.com/DgamesFoundation/subchain/fabric/core/system_chaincode/samplesyscc",
			InitArgs:  [][]byte{},
	...
	url := "github.com/DgamesFoundation/subchain/fabric/core/system_chaincode/sample_syscc"
	f := "putval"
