...
import (
	...
	"github.com/DgamesFoundation/subchain/fabric/core/chaincode/platforms"
	"github.com/DgamesFoundation/subchain/fabric/core/config"
...
func deployInternal(deployer crypto.Client, adminCert crypto.CertificateHandler) (resp *pb.Response, err error) {
	...
	spec := &pb.ChaincodeSpec{
		Type:        1,
		ChaincodeID: &pb.ChaincodeID{Path: "github.com/DgamesFoundation/subchain/fabric/examples/chaincode/go/asset_management"},
